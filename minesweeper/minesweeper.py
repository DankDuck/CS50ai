...
class Sentence():
    ...
    def known_mines(self):
        ...
        """
        # Cell(s) is not safe if len of cells is equal to mine count
        cell_count = len(self.cells)

        if cell_count == self.count and cell_count != 0:
            return self.cells
        return 0
    ...
    def known_safes(self):
        ...
        """
        # Cell is safe if sentence has 0 mine count
        cell_count = len(self.cells)

        if self.count == 0 and cell_count != 0:
            return self.cells
        return 0
...
class MinesweeperAI():
        ...
        while changed:
            ...
            for sentence1 in self.knowledge:
                for sentence2 in self.knowledge:
                    # If sentence1 is a subset of sentence2, then sentence2-sentence1 = count2-count1
    ...
    def make_random_move(self):
        ...
        """
        total_moves = self.width * self.height - 8
        possible_moves = len(self.moves_made)

        if possible_moves < total_moves:
            cell = MinesweeperAI.get_random_move(self)
