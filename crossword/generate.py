...
class CrosswordCreator():
    ...
    def enforce_node_consistency(self):
        ...
        """
        # Check if all possible words are the valid length, else remove them
        for v in self.domains:
            words = self.domains[v]
    ...
    def revise(self, x, y):
        ...
        """
        change = False
        # if no overlap return false or delete it
    ...
    def ac3(self, arcs=None):
        ...
        # Makes sure each arc is arc consistent
        while arcs:
            x,y = arcs.pop(0)
            if self.revise(x,y):
    ...
    def backtrack(self, assignment):
        ...
        """
        # Select an unassigned variable until assignment is completed
        # Once selected, pick out a value from the variable's domain and assign it to it
